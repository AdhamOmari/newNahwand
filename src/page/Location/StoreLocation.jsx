...
const StoreLocation = () => {
  ...
  const pageTitle =
    '  مطعم نهاوند بيت المشاوي الأعلى تقييمًا الخبر مشويات، أفضل مطعم'

  const siteDescription =
    'اختيار الشيف، سلطات طازجة بيت المشاوي، مشويات، مشاوي، أفضل مطعم، ريش غنم،أفضل مطعم مشاوي في الخبر ،أفضل مطعم لبناني ,افضل مشويات, اكل مصري، اكل لبناني، برياني هندي، مقبلات لبناني، باستا ايطالية، مشاوي شامية، مشاوي تركية، مانتو روز، كارديو كافيه لحوم بلدية، دجاج طازج'
