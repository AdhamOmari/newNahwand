...
const StoreLocation = () => {
  ...
  const pageTitle =
    'مطعم نهاوند بيت المشاوي الأعلى تقييمًا الخبر مشويات، مشاوي، أفضل مطعم، ريش غنم، أكل مصري، أكل لبناني، برياني  هندي، مقبلات لبنانية، باستا إيطالية، مشاوي شامية، مشاوي تركية مشاوي تركية، منتو روز، كارديو كافيه'
